...
text(bg, marginX, 0.965-topShift, 'RETINARESCUE  \bullet  CLINICAL AI SCREENING SUITE', ...
...
gridLabels = {'PREDICTED GRADE', 'CONFIDENCE', 'REFERABLE PROB.', 'DATE'};
gridValues = { ...
    char(result.predictedGrade), ...
    sprintf('%.1f%%', result.confidence*100), ...
