...
*The two rows above were measured with the plain-resize input the app used when this section was written.* The app now crops the retina and averages with the mirror image (`validation/results/stage3_pipeline.md`); with that input APTOS test is 95.1% / 89.2% / 0.977 / 0.837 and **IDRiD is 92.3% (88.8-94.7) / 67.4% (60.5-73.6) / 0.926 / 0.698**. The rest of this section describes the plain-resize behaviour that motivated the change.
