...
const MESSAGE_KEYS = {
  ...
  'Please verify your mobile number to continue.': 'msg.verifyFirst',
  'A new code has been sent.': 'msg.newCodeSent',
  'An account with this mobile number already exists.': 'msg.accountExists',
  'If an account exists for that number, a reset code has been sent.': 'msg.resetSent',
  ...
  'This number is already verified. Please sign in.': 'msg.alreadyVerified',
  'Full name is required.': 'msg.nameRequired',
  'Enter your full name.': 'msg.nameShort',
  'Mobile number is required.': 'msg.phoneRequired',
  'Enter a valid mobile number.': 'msg.phoneInvalid',
  'Enter the 6-digit code sent to your phone.': 'msg.code6',
